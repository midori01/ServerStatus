...
function get_status() {
    ...
    cd /tmp || exit
    wget "${MIRROR}https://github.com/midori01/serverstatus/releases/latest/download/server-${arch}-unknown-linux-musl.zip"
    wget "${MIRROR}https://github.com/midori01/serverstatus/releases/latest/download/client-${arch}-unknown-linux-musl.zip"
